...
dbname = "MedicalCost"   # Your database name
user = "postgres" # Your PostgreSQL username
password = "August@12345678"   # Your PostgreSQL password
...
try:
    ...
    for sheetName in sheetNames:
        ...
        # columnNames = ', '.join([s.replace(" ", "_") for s in columnNames_array]).lower()

        # Delete table if exist and creates new table
